...
sessionSchema.index({ webhookUrl: 1 });
...
// Webhook success
sessionSchema.methods.markWebhookSuccess = function () {
...
// Webhook failure
sessionSchema.methods.markWebhookFailure = function () {
...
sessionSchema.methods.getUptime = function () {
    ...
    return Math.floor((new Date() - this.connectedAt) / 1000);
};
